...
class BacklightBackend {
 public:
  BacklightBackend(std::chrono::milliseconds interval = std::chrono::milliseconds(1000), std::function<void()> on_updated_cb = NOOP);
